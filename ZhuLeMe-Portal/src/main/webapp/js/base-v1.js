 ...
 */
function login() {
    return location.href = "http://123.206.13.239:8084/page/login";
}
function regist() {
    return location.href = "http://123.206.13.239:8084/page/register";
}
...
function search(a) {
    var b = "http://123.206.13.239:8082/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
