...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://123.206.13.239:8081/rest/itemcat/all?callback=category.getDataService",
		//URL_Serv: "http://123.206.13.239:8082/category.json",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://123.206.13.239:8082/item/146892958091105.html"), '<a href="' + c + '">' + d + "</a>")
