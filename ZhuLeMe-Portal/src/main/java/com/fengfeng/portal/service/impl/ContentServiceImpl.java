...
import com.fengfeng.portal.service.ContentService;
...
public class ContentServiceImpl implements ContentService {
    ...
    public String getContentList() {
        ...
        //把字符串转换成结果
        try{
            FengfengResult fengfengResult = FengfengResult.formatToList(result, TbContent.class);
            //取内容列表
            List<TbContent> list= (List<TbContent>) fengfengResult.getData();
