...
<div class="w">
    <div id="logo">
    	<a href="http://www.jd.com" clstag="passport|keycount|login|01">
			<img src="/images/fengfeng-logo.jpg" alt="锋锋商城" width="235" height="78"/>
    	</a><b></b>
   	</div>
</div>
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						if (redirectUrl == "") {
							location.href = "http://123.206.13.239:8082/";
						} else {
